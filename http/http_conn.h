...
public:
    ...
    //设置写缓冲区的m_write_buf大小
    static const int WRITE_BUFFER_SIZE =2048;
    //报文的请求方法，只用到了GET和POST请求
    enum METHOD{
        GET=0,
        POST,
        HEAD,
...
private:
    ...
    LINE_STATUS parser_line();

    //根据响应的报文格式，生成对应的8个部分，以下函数均由do_request调用
...
private:
    ...
    //提高从磁盘读取数据到内存的效率，引入该机制，该结构体中包含指向数据的指针，和数据的长度
